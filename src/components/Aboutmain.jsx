        ...
        <div className='bg-[#0c0c0c] lg:p-10 p-2'>
          ...
          <div className='text-white lg:px-14 px-3 py-4 mt-5 flex w-full lg:gap-10 gap-3 items-center lg:flex-row flex-col'>
            ...
            <div className='lg:w-1/2 w-full text-white font-sans text-justify lg:text-xl text-base'>
              ...
              <h1 className='lg:text-5xl sm:text-4xl text-3xl font-medium lg:text-left text-center'>
                What is{' '}
              ...
              <div className='flex items-center mt-10'>
                <h1 className='lg:text-left text-center lg:text-2xl text-xl text-zinc-400'>
          ...
          <div className="opacity-95 lg:p-10 p-4">
            <div>
              ...
              <h2 className='mt-8 text-center lg:text-xl text-lg text-gray-300'>
                Secure Sharing, Engaging Learning, In-Depth Insights
              </h2>

              {/* Features Cards Container */}
              <div className='flex mt-10 lg:p-8 p-1 justify-between flex-wrap lg:gap-0 gap-10'>

                {/* Features list mapped into individual feature cards */}
                {[
